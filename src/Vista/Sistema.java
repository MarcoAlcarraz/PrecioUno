...
public final class Sistema extends javax.swing.JFrame {
    ...
    public Sistema (login priv){
        ...
        if (priv.getRol().equals("Asistente")) {
            ...
            jLabel2.setText(priv.getNombre());
        }else{
            jLabel2.setText(priv.getNombre());
        }
    }
    ...
    private void initComponents() {
        ...
        btnConfig.setText("Configurar datos de la empresa");
        ...
        jPanel5.add(txtIdproducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, -1, -1));
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel11Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(btnNuevoPro, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(jPanel11Layout.createSequentialGroup()
        ...
        jPanel5.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 250, 390));
        ...
        jPanel6.add(txtIdVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, 46, -1));
        ...
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/minimarket.png"))); // NOI18N
        jPanel7.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 90, 410, 290));
        ...
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 380, -1, -1));
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 240, 860, 460));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/1.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 10, 490, 210));
    ...
    private void RegistrarVenta() {
        ...
        String vendedor = jLabel2.getText();
    ...
    private void RegistrarDetalle() {
        ...
        int cliente = Integer.parseInt(txtIdCV.getText());
        Vdao.pdfV(id, cliente, Totalpagar, jLabel2.getText());
    }
